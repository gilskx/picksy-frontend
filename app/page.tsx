...
boxShadow: "0 10px 35px rgba(59,130,246,0.08)",
  ...
  <span style={{
    ...
    filter:
      "drop-shadow(0 0 8px rgba(99,102,241,0.22))"
  }}>
    <img
  src="/nokku-icon.png"
  alt="nokku.ai"
  style={{
    ...
    WebkitMaskImage:
      "radial-gradient(circle, black 62%, rgba(0,0,0,0.75) 74%, transparent 100%)",
    maskImage:
      "radial-gradient(circle, black 62%, rgba(0,0,0,0.75) 74%, transparent 100%)",

    filter:
      "drop-shadow(0 8px 18px rgba(59,130,246,0.18))"
  }}
/>
  </span>
...
letterSpacing: "-1.5px",
  ...
  <span>
    One search. Multiple stores, nokku.ai finds the best product, smarter alternatives, and better deals instantly.
  </span>
</div>
...
backdropFilter: "blur(18px)",
        ...
        boxShadow: `
          0 20px 50px rgba(148,163,184,0.16),
    ...
    >
      ...
      >
        ✨ One search across multiple stores. nokku.ai finds the best products, smarter alternatives, and better deals instantly.
      </div>
