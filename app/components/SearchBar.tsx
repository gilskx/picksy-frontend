...
export default function SearchBar({
 ...
 useEffect(() => {
  ...
  width: "calc(100% - 32px)",
  maxWidth: hasSearched ? "640px" : "720px",
  marginInline: "auto",
...
backdropFilter: "blur(22px)",
  ...
  padding: hasSearched ? "1px 4px" : "3px 6px",

  boxShadow: focused
  ? `
    0 0 0 3px rgba(59,130,246,0.18),
    0 22px 55px rgba(59,130,246,0.28),
    0 10px 24px rgba(15,23,42,0.10)
  `
  : `
    0 22px 55px rgba(59,130,246,0.22),
    0 10px 24px rgba(15,23,42,0.08)
  `,

transform: focused ? "translateY(-4px)" : "translateY(-2px)",
