...
export default function HeroRecommendation({
  ...
  if (!recommendation?.bestPick) return null;
...
<span style={{
  ...
  fontWeight: "600",
  fontSize: "16px",
  boxShadow: "0 20px 50px rgba(99,102,241,0.6)", // 🔥 stronger
...
<div style={{
  ...
  <div style={{
    ...
    {[
      ...
      "High user rating with strong reviews",
      "Reliable availability across stores",
  ...
  >
    <div style={{
      ...
      Save ${Math.abs(p.price - cheaper.price)}
    </div>
